# MindBuddy Python Advanced Improvement Plan

## Goal

Make MindBuddy Python feel closer to Claude Code in sustained coding sessions: reliable agent orchestration, responsive TUI, safe tools, strong context management, clean MCP integration, and measurable quality gates.
...
- Keep compatibility with the existing `mindbuddy-py`, `mindbuddy-headless`, `mindbuddy-gateway`, and `mindbuddy-cron` entry points.
...
2. Run `python -m compileall -q mindbuddy tests`.
...
Verification:
- `python -m compileall -q mindbuddy tests`
- `python -m pytest`
...
Risk:
- Permission persistence touches user-level files; tests should patch `MINDBUDDY_PERMISSIONS_PATH`.
...
Create:
- `mindbuddy/agent_events.py`
- `tests/test_agent_events.py`

Modify:
- `mindbuddy/agent_loop.py`
- `mindbuddy/tui/input_handler.py`
- `mindbuddy/headless.py`
...
- Manual mock run: `MINDBUDDY_MODEL_MODE=mock python -m mindbuddy.main`
...
Modify:
- `mindbuddy/tools/todo_write.py`
- `mindbuddy/task_tracker.py`
- `mindbuddy/tui/renderer.py`
...
Create:
- `mindbuddy/context_telemetry.py`
- `tests/test_context_telemetry.py`

Modify:
- `mindbuddy/agent_loop.py`
- `mindbuddy/tui/ui_hints.py`
...
Modify:
- `mindbuddy/tooling.py`
- `mindbuddy/agent_loop.py`
- Tool modules under `mindbuddy/tools/`
...
Modify:
- `mindbuddy/tooling.py`
- `mindbuddy/tools/run_command.py`
- `mindbuddy/tools/write_file.py`
- `mindbuddy/tools/edit_file.py`
- `mindbuddy/tools/patch_file.py`
