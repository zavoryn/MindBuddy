"""Unified model registry and routing for MindBuddy.
...
def build_provider_config(model: str, runtime: dict | None = None) -> ProviderConfig:
    ...
    if provider == Provider.OPENROUTER:
        return ProviderConfig(
            ...
            extra_headers={
                "HTTP-Referer": os.environ.get("OPENROUTER_REFERER", "https://github.com/mindbuddy-py"),
                "X-Title": os.environ.get("OPENROUTER_TITLE", "MindBuddy Python"),
            },
            extra_params={
...
def create_model_adapter(
    ...
    """
    if force_mock or os.environ.get("MINDBUDDY_MODEL_MODE") == "mock":
    ...
    if provider_config.is_openai_compatible:
        from mindbuddy.openai_adapter import OpenAIModelAdapter
    ...
    # Anthropic
    from mindbuddy.anthropic_adapter import AnthropicModelAdapter
