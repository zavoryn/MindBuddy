"""MindBuddy Python TTY Application.

This module implements the full-screen terminal user interface for MindBuddy,
including:
...
from mindbuddy.tui.tool_helpers import _summarize_collapsed_tool_body, _summarize_tool_input, _apply_tool_result_visual_state as _shared_apply_tool_result_visual_state, _mark_unfinished_tools as _shared_mark_unfinished_tools, _save_transcript as _shared_save_transcript
from mindbuddy.tui.event_flow import _handle_event as _handle_tty_event
from mindbuddy.tui.runtime_control import _ThrottledRenderer, enter_tty_runtime, exit_tty_runtime, install_sigwinch_rerender
from mindbuddy.tui.session_flow import handle_session_listing, load_or_create_session, build_tty_runtime_state, install_permission_prompt, finalize_tty_session
from mindbuddy.tui.renderer import _render_screen
from mindbuddy.tui.input_handler import _RawModeContext, _handle_input, _win_read_one_key
