"""Logging configuration for MindBuddy Python.
...
# 日志文件路径
LOG_FILE = MINDBUDDY_DIR / "mindbuddy.log"
...
def setup_logging(
    ...
    # 创建根 logger
    root_logger = logging.getLogger("mindbuddy")
...
def get_logger(name: str) -> logging.Logger:
    ...
    Returns:
        配置好的子 logger
    """
    return logging.getLogger(f"mindbuddy.{name}")
