...
def _print_usage() -> None:
    print(
        "mindbuddy management commands\n\n"
        "mindbuddy mcp list [--project]\n"
        "mindbuddy mcp add <name> [--project] [--protocol <auto|content-length|newline-json>] [--env KEY=VALUE ...] -- <command> [args...]\n"
        "mindbuddy mcp remove <name> [--project]\n\n"
        "mindbuddy skills list\n"
        "mindbuddy skills add <path-to-skill-or-dir> [--name <name>] [--project]\n"
        "mindbuddy skills remove <name> [--project]\n\n"
        "mindbuddy valid-config"
    )
