...
from mindbuddy.skills import discover_skills, load_skill


def test_discover_skills_prefers_project_root(tmp_path: Path, monkeypatch) -> None:
    project_skill = tmp_path / ".mindbuddy" / "skills" / "demo" / "SKILL.md"
    ...
    user_skill = user_home / ".mindbuddy" / "skills" / "demo" / "SKILL.md"
