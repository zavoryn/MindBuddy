"""End-to-end integration tests for MindBuddy Python.
...
class TestAgentLoopIntegration:
    ...
    def test_edit_file_via_agent(
        ...
        assert "Hello, MindBuddy!" in content
...
class TestSessionIntegration:
    ...
    def test_session_save_load_roundtrip(self, tmp_workspace):
        ...
        # Cleanup
        session_path = MINDBUDDY_DIR / "sessions" / "test-integration-001.json"
    ...
    def test_session_listing(self, tmp_workspace):
        ...
        # Cleanup
        for i in range(3):
            path = MINDBUDDY_DIR / "sessions" / f"test-list-{i:03d}.json"
            if path.exists():
                path.unlink()
