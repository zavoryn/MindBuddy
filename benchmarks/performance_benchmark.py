"""Performance benchmark suite for MindBuddy Python.
...
# Add parent directory to path to import mindbuddy
import sys
sys.path.insert(0, str(Path(__file__).parent.parent))

from mindbuddy.context_manager import estimate_tokens, estimate_message_tokens
...
from mindbuddy.tooling import ToolContext, ToolRegistry
...
def run_all_benchmarks() -> list[BenchmarkResult]:
    ...
    print("=" * 80)
    print("MindBuddy Python Performance Benchmark")
    print("=" * 80)
    print()
...
if __name__ == "__main__":
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write("MindBuddy Python Benchmark Results\n")
        f.write("=" * 80 + "\n\n")
        for r in results:
